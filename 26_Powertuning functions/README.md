...
For example, mine is `workshop-ebargues-dev-get-restaurants`.

Now, run the following (replace `xxx`)

```
lumigo-cli powertune-lambda -r eu-west-1 -n workshop-xxx-dev-get-restaurants --payload '{}' --strategy balanced
```
...
```
checking the aws-lambda-power-tuning SAR in [eu-west-1]
the latest version of aws-lambda-power-tuning SAR is 3.2.5
looking for deployed CloudFormation stack [serverlessrepo-lumigo-cli-powertuning-lambda] in [eu-west-1]
...
the State Machine is arn:aws:states:eu-west-1:374852340823:stateMachine:powerTuningStateMachine-7rCSp1kyv4TF
State Machine execution started
execution ARN is arn:aws:states:eu-west-1:374852340823:execution:powerTuningStateMachine-7rCSp1kyv4TF:ede4181f-21f0-47f1-8a59-cd750c637777
..
{
  "power": 512,
  "cost": 8.332e-7,
  ...
  "functionName": "workshop-ebargues-dev-get-restaurants"
}
...
```
lumigo-cli powertune-lambda -r eu-west-1 -n workshop-xxx-dev-get-index --payload '{}' --strategy balanced
```
