...
In our demo app, we don't actually have any secrets. But nonetheless, let's see how we _could_ store and load these secrets from SSM Parameter Store and make sure that they're securely handled.
...
You may even do yourself a favour and `promisify` the callback-style function that _Middy_ returns. e.g.
