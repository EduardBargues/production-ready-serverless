...
`curl -d '{"theme":"cartoon"}' -H "Content-Type: application/json" -X POST https://xxx.execute-api.eu-west-1.amazonaws.com/dev/restaurants/search`
...
`curl -d '{"theme":"cartoon"}' -H "Content-Type: application/json" -X POST https://xxx-api.eu-west-1.amazonaws.com/dev/restaurants/search`
